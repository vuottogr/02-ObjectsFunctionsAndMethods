...
def main():
    ...
    # better_draw_circles(rg.Point(100, 0), 17)

    #even_better_draw_circles(rg.Point(-100,-50), 11, 4, 'red', 3)

    even_better_draw_circles(rg.Point(0,0), 10, 10, 'yellow', 5)
    even_better_draw_circles(rg.Point(-125,0), 3, 5, 'yellow',5)
    even_better_draw_circles(rg.Point(125,0), 3, 5, 'yellow',5)
    even_better_draw_circles(rg.Point(0,-125), 3, 5, 'yellow',5)
    even_better_draw_circles(rg.Point(-0,125), 3, 5, 'yellow',5)
