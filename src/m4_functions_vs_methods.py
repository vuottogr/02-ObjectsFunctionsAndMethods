...
def try_methods_and_functions():
    ...
    ###########################################################################
    riley = rg.SimpleTurtle()
    riley.pen = rg.Pen('blue', 5)
    riley.backward(150)
    riley.speed = 1
    draw_many_squares(riley, 2, 100, 30)
    riley.speed = 5
    riley.pen = rg.Pen('red', 5)
    draw_many_squares(riley, 10, 50, 15)
    riley.speed = 100
    riley.pen = rg.Pen('red', 35)
    draw_many_squares(riley, 8, 300, 60)
    riley.pen = rg.Pen('black', 3)
    riley.backward(200)
    riley.draw_circle(30)
    riley.draw_square(50)
